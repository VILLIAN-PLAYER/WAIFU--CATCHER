...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    if user_data is None:
        ...
        *I am An Open Source Character Catcher Bot... Add Me to Your group. I will send Random Characters after every 30 messages in Group. 
        Use /guess to Collect those Characters in Your Collection and see Your Collection by using /Harem. 
        Add me to Your groups and start Collecting Your harem.*
        """
...
def main() -> None:
    ...
    # New start handler with the updated /start command
    start_handler = CommandHandler('start', start, block=False)
    application.add_handler(start_handler)

    # Execute the Telegram bot
